			...
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col-12">
						...
						<a href="index.html" class="original-logo"><img src="<?= base_url('assets') ?>/original/img/core-img/logosmk2.png" alt=""></a>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="carouselMultiItemExample" class="carousel slide carousel-dark text-center" data-mdb-ride="carousel">
		...
		<div class="carousel-inner py-4">
			...
			<div class="carousel-item active">
				<div class="container">
					<div class="row">
						<?php foreach ($galery as $uu) : ?>
						<div class="col-lg-4 mb-5">
							<div class="card">
								<img src="<?= base_url('assets/upload/galery/'.$uu['foto']) ?>" class="card-img-top" />
								<div class="card-body">
									<h5 class="card-title"><?= $uu['judul']?></h5>
									<p class="card-text">
									<?php echo date("l, d F Y", strtotime($uu['tanggal']))?>
									</p>
								</div>
							</div>
						</div>
